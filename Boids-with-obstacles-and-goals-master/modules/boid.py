...
class Boid(pygame.sprite.Sprite):
    ...
    def attack(self, target_list):
        ...
        ################################################################################################################
        target_id = sorted(target_ids, key=itemgetter(1)) # the key before is 0, but 0 is target, so I changed to 1
        del target_ids #target_ids is not sorted so I changed it to target_id
